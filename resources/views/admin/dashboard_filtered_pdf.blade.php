...
<head>
    ...
    <title>Filtered Dashboard PDF</title>
...
<div class="page-header">
    ...
    <div class="subtitle">Project Progress Overview - PDF Export</div>
    <div class="print-date">
        <i class="fas fa-calendar"></i> Generated on: {{ now()->format('Y-m-d H:i:s') }}
    </div>
</div>
