                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <div class="d-flex align-items-center">
                                <!-- Export buttons -->
                                <a href="<?php echo e(route('ds.export.pdf'), false); ?>" target="_blank" class="btn btn-sm btn-danger btn-export-pdf mr-1">
                                    <i class="fas fa-file-pdf"></i> PDF
                                </a>
                                <a href="<?php echo e(route('ds.export.excel'), false); ?>" class="btn btn-sm btn-success btn-export-excel mr-1">
                                    <i class="fas fa-file-excel"></i> Excel
                                </a>
                                <a href="<?php echo e(route('ds.print'), false); ?>" target="_blank" class="btn btn-sm btn-secondary btn-export-print mr-1">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $ds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($index + 1, false); ?></td>
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-primary" data-effect="effect-scale"
                                                data-dsname="<?php echo e($x->dsname, false); ?>"
                                                data-ds_contact="<?php echo e($x->ds_contact, false); ?>"
                                            ...
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="<?php echo e($x->id, false); ?>" data-dsname="<?php echo e($x->dsname, false); ?>"
                                                data-ds_contact="<?php echo e($x->ds_contact, false); ?>"
                                        ...
                                        <td><?php echo e($x->dsname, false); ?></td>
                                        <td class="ds-details">
                                            <div class="text-wrap">
                                                <?php echo e($x->ds_contact, false); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('ds.store'), false); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\MDSJEDPR\resources\views/dashboard/ds/index.blade.php ENDPATH**/ ?>