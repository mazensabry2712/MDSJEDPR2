...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(session()->has('delete')): ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong><?php echo e(session()->get('delete'), false); ?></strong>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong><?php echo e(session()->get('Error'), false); ?></strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
<?php endif; ?>
    ...
    <?php if(session()->has('edit')): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong><?php echo e(session()->get('edit'), false); ?></strong>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <div class="d-flex align-items-center">
        ...
        <!-- Export Buttons -->
        <a href="<?php echo e(route('pm.export.pdf'), false); ?>" target="_blank" class="btn btn-sm btn-danger btn-export-pdf mr-1">
            <i class="fas fa-file-pdf"></i> PDF
        </a>
        <a href="<?php echo e(route('pm.export.excel'), false); ?>" class="btn btn-sm btn-success btn-export-excel mr-1">
            <i class="fas fa-file-excel"></i> Excel
        </a>
        <a href="<?php echo e(route('pm.print'), false); ?>" target="_blank" class="btn btn-sm btn-secondary btn-export-print mr-1">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $ppms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($index + 1, false); ?></td>
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-primary" data-effect="effect-scale"
                                                data-id="<?php echo e($x->id, false); ?>" data-name="<?php echo e($x->name, false); ?>"
                                                data-email="<?php echo e($x->email, false); ?>" data-phone="<?php echo e($x->phone, false); ?>"
                                        ...
                                        <td><?php echo e($x->name, false); ?></td>
                                        <td><?php echo e($x->email, false); ?></td>
                                        <td><?php echo e($x->phone, false); ?></td>
                                    </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('pm.store'), false); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\MDSJEDPR\resources\views/dashboard/PMs/index.blade.php ENDPATH**/ ?>