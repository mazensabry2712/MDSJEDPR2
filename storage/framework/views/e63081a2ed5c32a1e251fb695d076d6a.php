            ...
            <div class="filter-card">
                ...
                <div class="card-body">
                    ...
                    <select id="customerSelect" class="form-control select2" data-placeholder="-- Select Customer --">
                        <option></option>
                        <?php $__currentLoopData = $filterOptions['customerNames']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customerName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($customerName, false); ?>"><?php echo e($customerName, false); ?></option>
            ...
            <div class="filter-card">
                ...
                <div class="card-body">
                    ...
                    <select id="vendorSelect" class="form-control select2" data-placeholder="-- Select Vendor --">
                        <option></option>
                        <?php $__currentLoopData = $filterOptions['vendorsList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendorName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($vendorName, false); ?>"><?php echo e($vendorName, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="filter-card">
                ...
                <div class="card-body">
                    ...
                    <select id="supplierSelect" class="form-control select2" data-placeholder="-- Select Supplier --">
                        <option></option>
                        <?php $__currentLoopData = $filterOptions['suppliers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplierName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($supplierName, false); ?>"><?php echo e($supplierName, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="filter-card">
                ...
                <div class="card-body">
                    ...
                    <select id="pmSelect" class="form-control select2" data-placeholder="-- Select PM --">
                        <option></option>
                        <?php $__currentLoopData = $filterOptions['projectManagers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pmName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($pmName, false); ?>"><?php echo e($pmName, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
            ...
            <div class="filter-card">
                ...
                <div class="card-body">
                    ...
                    <select id="amSelect" class="form-control select2" data-placeholder="-- Select AM --">
                        <option></option>
                        <?php $__currentLoopData = $filterOptions['ams']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($amName, false); ?>"><?php echo e($amName, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    function loadCustomerProjects(customerName) {
        ...
        // Make AJAX request
        $.ajax({
            url: '<?php echo e(route("reports.customer.projects"), false); ?>',
            method: 'GET',
    ...
    function exportAmProjectsToExcel() {
        ...
        const form = $('<form>', {
            method: 'POST',
            action: '<?php echo e(route('reports.export.am.projects'), false); ?>',
            target: '_blank'
        });

        form.append($('<input>', { type: 'hidden', name: '_token', value: '<?php echo e(csrf_token(), false); ?>' }));
    ...
    function loadVendorProjects(vendorName) {
        ...
        // Make AJAX request
        $.ajax({
            url: '<?php echo e(route("reports.vendor.projects"), false); ?>',
            method: 'GET',
    ...
    function exportVendorProjectsToExcel() {
        ...
        const form = $('<form>', {
            method: 'POST',
            action: '<?php echo e(route('reports.export.vendor.projects'), false); ?>',
            target: '_blank'
        });
    ...
    function exportCustomerProjectsToExcel() {
        ...
        const form = $('<form>', {
            method: 'POST',
            action: '<?php echo e(route('reports.export.customer.projects'), false); ?>',
            target: '_blank'
        });
    ...
    function exportSupplierProjectsToExcel() {
        ...
        const form = $('<form>', {
            method: 'POST',
            action: '<?php echo e(route("reports.export.supplier.projects"), false); ?>',
            target: '_blank'
        });
    ...
    function exportPMProjectsToExcel() {
        ...
        const form = $('<form>', {
            method: 'POST',
            action: '<?php echo e(route("reports.export.pm.projects"), false); ?>',
            target: '_blank'
        });
    ...
    function loadSupplierProjects(supplierName) {
        ...
        // Make AJAX request
        $.ajax({
            url: '<?php echo e(route("reports.supplier.projects"), false); ?>',
            method: 'GET',
    ...
    function loadPMProjects(pmName) {
        ...
        // Make AJAX request
        $.ajax({
            url: '<?php echo e(route("reports.pm.projects"), false); ?>',
            method: 'GET',
            data: { pm_name: pmName },
            success: function(response) {
    ...
    function loadAMProjects(amName) {
        ...
        // Make AJAX request
        $.ajax({
            url: '<?php echo e(route("reports.am.projects"), false); ?>',
            method: 'GET',
            data: { am_name: amName },
            success: function(response) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\MDSJEDPR\resources\views/dashboard/reports/index.blade.php ENDPATH**/ ?>