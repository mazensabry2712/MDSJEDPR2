...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="yourFormId" action="<?php echo e(route('dn.update',$dn->id), false); ?>" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['dn_number'];
...
unset($__errorArgs, $__bag); ?>" id="dn_number" name="dn_number"
                                    title="   Please enter the dn number "
                                    value="<?php echo e(old('dn_number', $dn->dn_number), false); ?>">
                                <?php $__errorArgs = ['dn_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col">
                                ...
                                <select name="pr_number" class="form-control SlectBox" id="pr_number_select_edit"
                                    ...
                                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr_numberr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($pr_numberr->id, false); ?>"
                                            data-project-name="<?php echo e($pr_numberr->name, false); ?>"
                                            <?php if(old('pr_number', $dn->pr_number) == $pr_numberr->id): ?> selected <?php endif; ?>>
                                            <?php echo e($pr_numberr->pr_number, false); ?>
                            ...
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="date" name="date"
                                    ...
                                    value="<?php echo e(old('date', $dn->date), false); ?>">
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col">
    ...
    <script>
        $(document).ready(function() {
            $('select[name="ds_id"]').on('change', function() {
                ...
                if (SectionId) {
                    $.ajax({
                        url: "<?php echo e(URL::to('ds_id'), false); ?>/" + SectionId,
                        type: "GET",
                        dataType: "json",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\MDSJEDPR\resources\views/dashboard/DN/edit.blade.php ENDPATH**/ ?>