<!-- main-sidebar -->
<aside class="app-sidebar sidebar-scroll" style="height: 100vh; overflow-y: auto; overflow-x: hidden;">
    <!-- Logo Section -->
    <div class="sidebar-logo-container" style="text-align: center; padding: 15px 10px; margin-bottom: 10px; background: #fff;">
        <a href="{{ route('dashboard.index') }}" class="sidebar-logo-link" aria-label="Go to dashboard">
            <img src="{{ asset('assets/img/brand/logoo.png') }}"
                 style="max-width: 100%; height: auto; width: 160px; display: block; margin: 0 auto;"
    ...
    <div class="main-sidemenu" style="padding-bottom: 50px;">
        <ul class="side-menu">
            ...
            @if(auth()->user()->can('show users') || auth()->user()->can('show roles'))
