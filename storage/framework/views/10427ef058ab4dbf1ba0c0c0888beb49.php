...
<div class="page-header">
    ...
    <div class="print-date">
        <i class="fas fa-calendar"></i> Printed on: <?php echo e(now()->format('Y-m-d H:i:s'), false); ?>
    ...
    <div class="project-card">
        ...
        <div class="card-header">
            <h3>
                ...
                <span class="pr-badge">PR# <?php echo e($project->pr_number, false); ?></span>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="info-grid">
                <div class="info-box">
                    ...
                    <div class="value"><?php echo e($project->cust->name ?? 'N/A', false); ?></div>
                </div>
                <div class="info-box pm">
                    <div class="label">
                        <i class="fas fa-user-tie" style="color: #28a745;"></i> PM
                    </div>
                    <div class="value"><?php echo e($project->ppms->name ?? 'N/A', false); ?></div>
                </div>
                ...
                <div class="info-box value">
                    ...
                    <div class="value"><?php echo e(number_format($project->value ?? 0, 0), false); ?> SAR</div>
                </div>
                <?php endif; ?>
                <div class="info-box date">
                    ...
                    <div class="value"><?php echo e($project->customer_po_date ?? 'N/A', false); ?></div>
                </div>
                <div class="info-box tech">
                    <div class="label">
                        <i class="fas fa-code" style="color: #6f42c1;"></i> Technologies
                    </div>
                    <div class="value"><?php echo e($project->technologies ?? 'N/A', false); ?></div>
                </div>
            </div>
            ...
            <div class="progress-section">
                ...
                <div class="progress-bar-container">
                    <div class="progress-bar-fill" style="width: <?php echo e($progress, false); ?>%;"></div>
                </div>
                ...
                <div class="expected-date">
                    ...
                    <div class="date-value"><?php echo e($project->latestStatus && $project->latestStatus->expected_completion ? \Carbon\Carbon::parse($project->latestStatus->expected_completion)->format('d/m/Y') : 'Not Set', false); ?></div>
                </div>
            </div>
            ...
            <div class="details-grid">
                ...
                <div class="detail-card tasks">
                    ...
                    <div class="card-content">
                        ...
                        ?>
                        <?php if($pendingTasksList->count() > 0): ?>
                            <?php $__currentLoopData = $pendingTasksList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="detail-item">
                                    <span class="detail-name"><?php echo e($task->details ?? 'Task', false); ?></span>
                                    <i class="fas fa-long-arrow-alt-right detail-arrow"></i>
                                    <span class="detail-assigned"><?php echo e($task->assigned ?? 'N/A', false); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <div class="no-data">No pending tasks</div>
                        <?php endif; ?>
                        <div class="detail-summary"><?php echo e($pendingTasks, false); ?>/<?php echo e($totalTasks, false); ?> Pending</div>
                    </div>
                </div>
                ...
                <div class="detail-card risks">
                    ...
                    <div class="card-content">
                        ...
                        ?>
                        <?php if($risksList->count() > 0): ?>
                            <?php $__currentLoopData = $risksList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $risk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="detail-item">
                                    <span class="detail-name"><?php echo e($risk->risk ?? 'Risk', false); ?></span>
                                    <i class="fas fa-long-arrow-alt-right detail-arrow"></i>
                                    <span class="detail-assigned"><?php echo e($risk->impact ?? 'N/A', false); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <div class="no-data">No risks recorded</div>
                        <?php endif; ?>
                        <div class="detail-summary"><?php echo e($project->risks->count(), false); ?> Total</div>
                    </div>
                </div>
                ...
                <div class="detail-card milestones">
                    ...
                    <div class="card-content">
                        ...
                        ?>
                        <?php if($milestonesList->count() > 0): ?>
                            <?php $__currentLoopData = $milestonesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="detail-item">
                                    <span class="detail-name"><?php echo e($milestone->milestone ?? 'Milestone', false); ?></span>
                                    <i class="fas fa-long-arrow-alt-right detail-arrow"></i>
                                    <span class="detail-assigned"><?php echo e($milestone->status ?? 'N/A', false); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <div class="no-data">No milestones</div>
                        <?php endif; ?>
                        <div class="detail-summary"><?php echo e($project->milestones->count(), false); ?> Total</div>
                    </div>
                </div>
                ...
                <div class="detail-card invoices">
                    ...
                    <div class="card-content">
                        ...
                        ?>
                        <?php if($invoicesList->count() > 0): ?>
                            <?php $__currentLoopData = $invoicesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="detail-item">
                                    <span class="detail-name"><?php echo e($invoice->invoice_number ?? 'Invoice', false); ?></span>
                                    <i class="fas fa-long-arrow-alt-right detail-arrow"></i>
                                    <span class="detail-assigned"><?php echo e(number_format($invoice->value ?? 0), false); ?> SAR</span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <div class="no-data">No invoices</div>
                        <?php endif; ?>
                        <div class="detail-summary"><?php echo e($paidInvoices, false); ?>/<?php echo e($project->invoices->count(), false); ?> Paid</div>
                    </div>
                </div>
                <?php endif; ?>
                    ...
                    <div class="card-content">
                        ...
                        <?php if($dnsCount > 0): ?>
                            <div style="display: flex; flex-wrap: wrap; gap: 4px; margin-bottom: 6px;">
                                <?php $__currentLoopData = $dnsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php endif; ?>
                        <div class="detail-summary"><?php echo e($dnsCount, false); ?> Total</div>
                    </div>
                </div>
...
<?php /**PATH C:\Herd\MDSJEDPR\resources\views/admin/dashboard_filtered_print.blade.php ENDPATH**/ ?>