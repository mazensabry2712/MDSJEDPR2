...
<?php $__env->startSection('css'); ?>
    ...
    <link href="<?php echo e(URL::asset('assets/css/export-buttons.css'), false); ?>" rel="stylesheet">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <div class="d-flex align-items-center">
                                ...
                                <a href="<?php echo e(route('am.export.pdf'), false); ?>" target="_blank" class="btn btn-sm btn-danger btn-export-pdf mr-1">
                                    <i class="fas fa-file-pdf"></i> PDF
                                </a>
                                <a href="<?php echo e(route('am.export.excel'), false); ?>" class="btn btn-sm btn-success btn-export-excel mr-1">
                                    <i class="fas fa-file-excel"></i> Excel
                                </a>
                                <a href="<?php echo e(route('am.print'), false); ?>" target="_blank" class="btn btn-sm btn-secondary btn-export-print mr-1">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $aams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('am.store'), false); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\MDSJEDPR\resources\views/dashboard/AMs/index.blade.php ENDPATH**/ ?>