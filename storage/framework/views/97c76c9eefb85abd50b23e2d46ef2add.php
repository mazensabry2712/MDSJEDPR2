                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <div class="d-flex align-items-center">
                                <!-- Export buttons -->
                                <a href="<?php echo e(route('vendors.export.pdf'), false); ?>" target="_blank" class="btn btn-sm btn-danger btn-export-pdf mr-1">
                                    <i class="fas fa-file-pdf"></i> PDF
                                </a>
                                <a href="<?php echo e(route('vendors.export.excel'), false); ?>" class="btn btn-sm btn-success btn-export-excel mr-1">
                                    <i class="fas fa-file-excel"></i> Excel
                                </a>
                                <a href="<?php echo e(route('vendors.print'), false); ?>" target="_blank" class="btn btn-sm btn-secondary btn-export-print mr-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-primary" data-effect="effect-scale"
                                                data-vendors="<?php echo e($vendor->vendors, false); ?>"
                                                data-vendor_am_details="<?php echo e($vendor->vendor_am_details, false); ?>"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit')): ?>
                                                <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                    data-id="<?php echo e($vendor->id, false); ?>" data-vendors="<?php echo e($vendor->vendors, false); ?>"
                                                    data-vendor_am_details="<?php echo e($vendor->vendor_am_details, false); ?>" data-toggle="modal"
                                        ...
                                        <td><?php echo e($vendor->vendors, false); ?></td>
                                        <td class="vendor-am-details">
                                            <div class="text-wrap">
                                                <?php echo e($vendor->vendor_am_details, false); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('vendors.store'), false); ?>" method="post">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\MDSJEDPR\resources\views/dashboard/vendors/index.blade.php ENDPATH**/ ?>