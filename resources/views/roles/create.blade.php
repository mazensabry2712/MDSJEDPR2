...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Permissions</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Add Permission</span>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('name', old('name'), ['class' => 'form-control', 'id' => 'name', 'placeholder' => 'Enter permission name', 'required' => true]) !!}
                            </div>
                        </div>
                    </div>
                                        ...
                                        @foreach($permission as $value)
                                            <li>
                                                <label style="font-size: 14px; font-weight: normal;">
                                                    {{ Form::checkbox('permission[]', $value->id, in_array($value->id, old('permission', [])), ['class' => 'name permission-checkbox', 'data-permission' => $value->name]) }}
                                                    {{ $value->name }}
                                                </label>
                                            </li>
                                        @endforeach
