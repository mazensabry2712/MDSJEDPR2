...
<head>
    ...
    <title>Print Project Risks</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="header">
        <h1>MDSJEDPR</h1>
        <h2>Project Risks Management</h2>
        <div class="date">
        ...
        <tbody>
            @forelse ($risks as $index => $item)
                <tr>
                    ...
                    <td>
                        <div class="text-wrap">{{ $item->risk ?: 'No risk description' }}</div>
                    </td>
                    <td class="text-center">
                        @if($item->impact == 'low')
                            <span class="badge badge-success">Low</span>
                        @elseif($item->impact == 'med')
                    ...
                    <td>
                        <div class="text-wrap">{{ $item->mitigation ?: 'N/A' }}</div>
                    </td>
