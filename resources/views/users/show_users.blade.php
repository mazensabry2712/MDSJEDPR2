...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Usres</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Usres
                List</span>
        </div>
    </div>
</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Delete Usre</h6><button aria-label="Close" class="close"
                ...
                <form action="{{ route('users.destroy', 'test') }}" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancele</button>
