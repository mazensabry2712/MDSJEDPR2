                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <div class="d-flex align-items-center">
                                ...
                                <!-- Export Buttons -->
                                <a href="<?php echo e(route('coc.export.pdf'), false); ?>" target="_blank" class="btn btn-sm btn-danger btn-export-pdf mr-1" title="Export to PDF">
                                    <i class="fas fa-file-pdf"></i> PDF
                                </a>
                                <a href="<?php echo e(route('coc.export.excel'), false); ?>" class="btn btn-sm btn-success btn-export-excel mr-1" title="Export to Excel">
                                    <i class="fas fa-file-excel"></i> Excel
                                </a>
                                <a href="<?php echo e(route('coc.print'), false); ?>" target="_blank" class="btn btn-sm btn-secondary btn-export-print mr-1" title="Print">
                                    <i class="fas fa-print"></i> Print
                                </a>

                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Add')): ?>
                                    <a class="btn btn-primary" data-effect="effect-scale" href="<?php echo e(route('coc.create'), false); ?>">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tbody>
                                <?php $i = 0; ?>
                                <?php $__currentLoopData = $coc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $i++; ?>
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a class="btn btn-sm btn-primary"
                                                    href="<?php echo e(route('coc.show', $item->id), false); ?>" title="View">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit')): ?>
                                                <a class="btn btn-sm btn-info"
                                                    href="<?php echo e(route('coc.edit', $item->id), false); ?>" title="Update">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete')): ?>
                                                <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                    ...
                                                    data-project_name="<?php echo e($item->project->name ?? 'N/A', false); ?>"
                                        ...
                                        <td>
                                            <?php if($item->project && $item->project->pr_number): ?>
                                                <span class="badge badge-primary" style="font-size: 11px; padding: 5px 10px;">
                                                    <i class="fas fa-hashtag mr-1"></i>
                                                    <?php echo e($item->project->pr_number, false); ?>
                                        ...
                                        <td>
                                            <?php if($item->coc_copy && file_exists(public_path('../storge/' . $item->coc_copy))): ?>
                                                <?php
                                                ...
                                                <?php if($isImage): ?>
                                                    <a href="<?php echo e(asset($filePath), false); ?>" data-lightbox="gallery-<?php echo e($item->id, false); ?>"
                                                         data-title="CoC Copy - <?php echo e($item->project->name ?? 'N/A', false); ?>" title="Click to view full size">
                                                        <img src="<?php echo e(asset($filePath), false); ?>" alt="CoC Copy"
                                                             height="50" width="50" class="image-thumbnail"
                                                             title="CoC Copy - Click to enlarge">
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(asset($filePath), false); ?>" target="_blank"
                                        ...
                                        <td>
                                            <div class="date-info">
                                                ...
                                                <?php echo e($item->created_at->format('Y-m-d'), false); ?>

                                            </div>
                                            <div class="date-info">
                                                <i class="fas fa-clock"></i>
                                                <?php echo e($item->created_at->format('h:i A'), false); ?>
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="<?php echo e(route('coc.destroy', 'test'), false); ?>" method="post">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\MDSJEDPR\resources\views/dashboard/CoC/index.blade.php ENDPATH**/ ?>