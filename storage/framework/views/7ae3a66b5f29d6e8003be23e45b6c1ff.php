...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="sidebar-logo-container">
        <a href="<?php echo e(url('/dashboard'), false); ?>" class="sidebar-logo-link">
            <img src="<?php echo e(URL::asset('assets/img/brand/logosidbar.png'), false); ?>" class="sidebar-main-logo" alt="MDSJEDPR Logo">
        </a>
    </div>
    ...
    <div class="main-sidemenu">
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(url('dashboard'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
 ...
 <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('epo.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('projects.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('customer.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('pm.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('am.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('vendors.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('ds.index'), false); ?>">
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('invoices.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('dn.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('coc.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('ppos.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('pstatus.index'), false); ?>"><svg
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('ptasks.index'), false); ?>"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('risks.index'), false); ?>"><svg xmlns="http://www.w3.org/2000/svg"
                        class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('milestones.index'), false); ?>"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <li class="slide">
                <a class="side-menu__item" href="<?php echo e(route('reports.index'), false); ?>"><svg
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="<?php echo e(url('/' . ($page = '#')), false); ?>"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="<?php echo e(url('/' . ($page = 'users')), false); ?>">User List</a></li>
                    

                    
                    <li><a class="slide-item" href="<?php echo e(url('/' . ($page = 'roles')), false); ?>">User Permissions</a></li>
...
<!-- main-sidebar -->
<?php /**PATH C:\Herd\MDSJEDPR\resources\views/layouts/main-sidebar.blade.php ENDPATH**/ ?>