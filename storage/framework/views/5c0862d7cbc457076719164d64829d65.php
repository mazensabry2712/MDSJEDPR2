                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-center">
                            <!-- Export Buttons -->
                            <a href="<?php echo e(route('projects.export.pdf'), false); ?>" class="btn btn-sm btn-danger btn-export-pdf mr-1" target="_blank">
                                <i class="fas fa-file-pdf"></i> PDF
                            </a>

                            <a href="<?php echo e(route('projects.export.excel'), false); ?>" class="btn btn-sm btn-success btn-export-excel mr-1">
                                <i class="fas fa-file-excel"></i> Excel
                            </a>

                            <a href="<?php echo e(route('projects.print'), false); ?>" class="btn btn-sm btn-secondary btn-export-print mr-2" target="_blank">
                                <i class="fas fa-print"></i> Print
                            </a>

                            <!-- Add New Project Button -->
                            <a class="btn btn-primary" href="<?php echo e(route('projects.create'), false); ?>">
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($index + 1, false); ?></td>
                                        <td class="text-center action-buttons">
                                            <!-- View Project -->
                                            <a href="<?php echo e(route('projects.show', $project->id), false); ?>"
                                                class="btn btn-sm btn-primary" title="View Details">
                                                <i class="las la-eye"></i>
                                            </a>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit')): ?>
                                                <a href="<?php echo e(route('projects.edit', $project->id), false); ?>"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete')): ?>
                                                <a class="btn btn-sm btn-danger" data-effect="effect-scale"
                                                    data-id="<?php echo e($project->id, false); ?>" data-name="<?php echo e($project->name, false); ?>"
                                        ...
                                        <td>
                                            <?php if($project->pr_number): ?>
                                                <span
                                                    class="badge badge-primary badge-custom"><?php echo e($project->pr_number, false); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">N/A</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="font-weight-bold"><?php echo e($project->name, false); ?></td>
                                        <td>
                                            <?php if($project->technologies): ?>
                                                <span
                                                    class="badge badge-info badge-custom"><?php echo e($project->technologies, false); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">N/A</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($project->vendors && $project->vendors->count() > 0): ?>
                                                <?php $__currentLoopData = $project->vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td>
                                            <?php if($project->deliverySpecialists && $project->deliverySpecialists->count() > 0): ?>
                                                <?php $__currentLoopData = $project->deliverySpecialists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span
                                                        class="badge badge-<?php echo e($ds->pivot->is_lead ? 'success' : 'info', false); ?> badge-custom mr-1">
                                                        <?php echo e($ds->dsname, false); ?>

                                                        <?php if($ds->pivot->is_lead): ?>
                                        ...
                                        <td><?php echo e($project->cust->name ?? 'N/A', false); ?></td>
                                        <td><?php echo e($project->customer_po ?? 'N/A', false); ?></td>
                                        <td class="text-center">
                                            <?php if($project->value): ?>
                                                <span
                                                    class="badge badge-success badge-custom">$<?php echo e(number_format($project->value, 2), false); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">N/A</span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($project->aams->name ?? 'N/A', false); ?></td>
                                        <td><?php echo e($project->ppms->name ?? 'N/A', false); ?></td>
                                        <td>
                                            <?php if($project->customer_contact_details): ?>
                                                <span title="<?php echo e($project->customer_contact_details, false); ?>">
                                                    <?php echo e(Str::limit($project->customer_contact_details, 30), false); ?>
                                        ...
                                        <td class="text-center">
                                            <?php if($project->po_attachment && file_exists(public_path($project->po_attachment))): ?>
                                                <?php
                                                ...
                                                ?>
                                                <?php if($isImage): ?>
                                                    <a href="<?php echo e(asset($project->po_attachment), false); ?>"
                                                        data-lightbox="gallery-<?php echo e($project->id, false); ?>"
                                                        data-title="PO Attachment - <?php echo e($project->pr_number, false); ?>"
                                                        title="Click to view full size">
                                                        <img src="<?php echo e(asset($project->po_attachment), false); ?>"
                                        ...
                                        <td class="text-center">
                                            <?php if($project->epo_attachment && file_exists(public_path($project->epo_attachment))): ?>
                                                <?php
                                                    $fileExtension = strtolower(
                                                ...
                                                ?>
                                                <?php if($isImage): ?>
                                                    <a href="<?php echo e(asset($project->epo_attachment), false); ?>"
                                                        data-lightbox="gallery-<?php echo e($project->id, false); ?>"
                                                        data-title="EPO Attachment - <?php echo e($project->pr_number, false); ?>"
                                                        title="Click to view full size">
                                                        <img src="<?php echo e(asset($project->epo_attachment), false); ?>"
                                        ...
                                        <td class="text-center">
                                            <?php if($project->customer_po_date): ?>
                                                <span
                                                    class="badge badge-light badge-custom"><?php echo e(\Carbon\Carbon::parse($project->customer_po_date)->format('M d, Y'), false); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">N/A</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center">
                                            <?php if($project->customer_po_duration): ?>
                                                <span
                                                    class="badge badge-secondary badge-custom"><?php echo e($project->customer_po_duration, false); ?>
                                        ...
                                        <td class="text-center">
                                            <?php if($project->customer_po_deadline): ?>
                                                <?php
                                                    $deadline = \Carbon\Carbon::parse($project->customer_po_deadline);
                                                    $isOverdue = $deadline->isPast();
                                                ?>
                                                <span class="<?php echo e($isOverdue ? 'text-danger' : 'text-success', false); ?>">
                                                    <?php echo e($deadline->format('M d, Y'), false); ?>
                                        ...
                                        <td class="project-description">
                                            <?php if($project->description): ?>
                                                <div class="text-wrap">
                                                    <?php echo e($project->description, false); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(URL::asset('assets/plugins/datatable/js/pdfmake.min.js'), false); ?>"></script>
    ...
    <script>
        $('#modaldemo9').on('show.bs.modal', function(event) {
            ...
            modal.find('form').attr('action', '<?php echo e(route('projects.destroy', ':id'), false); ?>'.replace(':id', id));
    ...
    <!-- Export Functions -->
    <script src="<?php echo e(URL::asset('assets/js/export-functions.js'), false); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Herd\MDSJEDPR\resources\views/dashboard/projects/index.blade.php ENDPATH**/ ?>